  ...
  return (
    <div className="app-container">
      ...
      <div className="main-content">
        <Header />
        <main className="content-wrapper p-3 p-md-4">
          {children}
        </main>
      </div>
    </div>
    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/admin/notificacoes/cadastrar" element={
            <PrivateRoute requiredRole="TECNICO">
              <AuthenticatedLayout> <CadastrarNotificacaoPage /> </AuthenticatedLayout>
            </PrivateRoute>
          } />
          ...
          <Route path="/admin/editar-perfil" element={
            <PrivateRoute requiredRole="TECNICO">
              <AuthenticatedLayout> <AdminEditarPerfilPage /> </AuthenticatedLayout>
            </PrivateRoute>
          } />
